create table cw_waiting_history
(
...
create index cw_waiting_history_shop_id_index
    on cw_waiting_history (shop_id);
create index cw_waiting_history_operation_date_index
    on cw_waiting_history (operation_date);
create index cw_waiting_history_customer_seq_index
    on cw_waiting_history (customer_seq);
